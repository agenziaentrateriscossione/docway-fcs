...
commons-daemon\docway-fcs //IS//"docway-fcs" --DisplayName="docway-fcs" --Description="docway-fcs"^
	 --Jvm=%JVM%^
     --Install="%cd%\commons-daemon\docway-fcs.exe" --StartMode=jvm --StopMode=jvm^
